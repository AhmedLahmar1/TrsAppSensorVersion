...
import com.example.TRS_VIEW.chronometer.ChronometerEngineReglage;

public class ChronometerServiceReglage extends Service {

    private static final String TAG3 = ChronometerServiceReglage.class.getSimpleName();
    private final IBinder mBinder3 = new LocalBinder();
    private ChronometerEngineReglage mChronometerEngine3;

    /**
     *
     */
    public class LocalBinder extends Binder {
        public ChronometerServiceReglage getService() {
            return ChronometerServiceReglage.this;
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        mChronometerEngine3 = new ChronometerEngineReglage();
    }
